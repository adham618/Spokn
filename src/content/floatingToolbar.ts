      ...
      <div id="spokn-settings" class="${this.settingsOpen ? 'open' : ''}">
        ...
        <div class="settings-section">
          ...
          <div id="spokn-version">
            ...
            &nbsp;·&nbsp;
            <a id="spokn-github-link" href="https://github.com/adhamtarek/spokn" target="_blank" rel="noopener noreferrer" title="View source on GitHub">
  ...
  private static buildCSS(): string {
    return `
      ...
      */
      ...
      #spokn-github-link:hover { opacity: 1; text-decoration: underline; }
